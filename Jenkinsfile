        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t jd09/devopsexam:${IMAGE_NAME} ."
      ...
      stage('deploy') {
        input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'jd09', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    sh "echo ${PASSWORD} | docker login -u ${USERNAME} --password-stdin"
                    sh "docker push jd09/devopsexam:${IMAGE_NAME}"
                }}
